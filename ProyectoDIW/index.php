            ...
            <article class="row">
                ...
                <div class="col-md-6 col-lg-3 mt-3 mt-lg-0 ">
                    <div class="card h-100  border-0 shadow">
                        <img src="assets/img/home/home_Comics.jpg" class="card-img-top p-5 border"/>
                ...
                <div class="col-md-6 col-lg-3 mt-3 mt-lg-0 ">
                    <div class="card h-100 border-0 shadow">
                        <img src="assets/img/home/home_peliculas.jpg" class="card-img-top p-5 border"/>
                        <div class="card-body text-justify">
                ...
                <div class="col-md-6 col-lg-3 mt-3 mt-lg-0 ">
                    <div class="card h-100 border-0 shadow">
                        <img src="assets/img/home/home_Videojuegos.jpg" class="card-img-top p-5 border"/>
                        <div class="card-body text-justify">
                ...
                <div class="col-md-6 col-lg-3 mt-3 mt-lg-0 ">
                    <div class="card h-100 border-0 shadow">
                        <img src="assets/img/home/home_personajes.jpg" class="card-img-top p-5 border"/>
                        <div class="card-body text-justify">
