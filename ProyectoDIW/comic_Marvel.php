...
<body>
    ...
    <section class="container-fluid">
        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="font-weight-bold text-primary">Capitana Marvel</h3>
                </div>
        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="font-weight-bold text-primary">Iron Man</h3>
                </div>
        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="font-weight-bold text-primary">Spider-Man</h3>
                </div>
